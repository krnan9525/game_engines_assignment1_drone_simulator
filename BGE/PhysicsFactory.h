...
namespace BGE
{
	...
	public:
		...
		//shared_ptr<Friction_Controller> CreateBox2(float width, float height, float depth, glm::vec3 pos, glm::quat quat, bool kinematic = false, bool attachToGame = true);
		...
		shared_ptr<Friction_Controller> CreateCylinder2(float radius, float height, glm::vec3 pos, glm::quat quat, string = "cylinder", bool kinematic = false, bool attachToGame = true);
